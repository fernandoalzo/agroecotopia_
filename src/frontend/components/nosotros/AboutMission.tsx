...
interface AboutMissionProps { t: any; }
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              ...
              <div className="z-10 text-center">
                <span className="mb-4 block font-display text-6xl font-black text-primary/30 md:text-8xl select-none">CAMPO</span>
                <span className="block font-display text-4xl font-bold tracking-widest text-foreground/20 italic select-none">CONECTADO</span>
              </div>
            </div>
