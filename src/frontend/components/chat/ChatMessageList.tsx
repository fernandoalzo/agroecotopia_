...
//     const emptyTitle = parts.length > 1 ? parts[0] + "!" : noMessagesText;
//     const emptySubtitle = parts.length > 1 ? parts[1] : "";
...
//                                 </span>
//                                 <span className="text-muted-foreground/90 font-medium">{typingText}</span>
//                             </div>
//                         </div>
//                     )}
