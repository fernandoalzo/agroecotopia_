...
export function useChatWidget(forceShow: boolean, targetUserId?: string, enabled = true, deps?: Partial<ChatWidgetDeps>) {
    ...
    const t = {
        es: {
            ...
            aiTitle: `Asistente ${config.app.name}`,
            aiSubtitle: "Asistente con IA",
            aiThinking: "El asistente está pensando...",
            aiNoMessages: `¡Hola! Soy el asistente IA de ${config.app.name}. Pregúntame sobre productos, cultivos, plagas o cómo funciona la plataforma.`,
        ...
        en: {
            ...
            aiTitle: `${config.app.name} AI`,
            aiSubtitle: "AI Assistant",
            aiThinking: "The assistant is thinking...",
            aiNoMessages: `Hi! I'm the ${config.app.name} AI assistant. Ask me about products, crops, pests, or how the platform works.`,
