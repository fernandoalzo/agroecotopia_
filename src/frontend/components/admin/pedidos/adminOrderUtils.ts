...
export const statusConfig = {
  ...
  [PedidoEstado.EN_CAMINO]: {
    ...
    hoverClasses: "hover:border-sky-500/50 hover:shadow-[0_10px_35px_-5px_rgba(14,165,233,0.25)] hover:bg-sky-500/10 dark:hover:bg-sky-500/15",
  ...
  [PedidoEstado.CANCELADO]: {
    ...
    hoverClasses: "hover:border-rose-500/50 hover:shadow-[0_10px_35px_-5px_rgba(244,63,94,0.25)] hover:bg-rose-500/10 dark:hover:bg-rose-500/15",
