...
export const AdminOrderCard = ({ order, index, isUpdating, onUpdateStatus, onOpenOrderChat, unreadChatCount, isOpeningChat, onOpenOrderDetail, onNavigateToEnvio, navigatingEnvioOrderId }: AdminOrderCardProps) => {
