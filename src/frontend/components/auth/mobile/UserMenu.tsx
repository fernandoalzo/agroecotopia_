...
export const UserMenuMobile = ({
    ...
    return (
        <motion.div
            ...
            className="fixed inset-0 top-0 z-[200] flex h-[100dvh] w-full flex-col bg-background md:hidden overflow-y-auto overscroll-none"
        >
            ...
            <div className="relative flex flex-col min-h-full px-6 pt-24 pb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-between w-full p-4 rounded-2xl bg-card border border-border backdrop-blur-sm active:scale-95 transition-all text-card-foreground shadow-sm"
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <span className="block text-xs text-muted-foreground">{isDark ? "Tema nocturno" : "Tema diurno"}</span>
                                    </div>
                                </div>
                                <div className={cn(
                                    "relative inline-flex h-7 w-12 items-center rounded-full transition-colors",
                                    isDark ? "bg-indigo-500/30" : "bg-primary/20"
                                )}>
                                    <span className={cn(
                                        "inline-block h-5 w-5 transform rounded-full shadow-md transition-transform",
                                        isDark ? "translate-x-6 bg-indigo-400" : "translate-x-1 bg-primary"
                                    )} />
                                </div>
                            </button>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {languages.map((lang) => (
                                    <button
                                        ...
                                        className={cn(
                                            "flex flex-col gap-3 p-4 rounded-2xl border backdrop-blur-sm active:scale-95 transition-all outline-none shadow-sm",
                                            language === lang.code
                                    ...
                                    >
                                        ...
                                        <div className="text-left">
                                            <span className="block font-bold text-base text-foreground">{lang.label}</span>
                                            <span className="block text-[10px] opacity-70">{lang.region}</span>
                                        </div>
                                    </button>
                                ))}
                            </div>
                ...
                <div className="mt-auto space-y-4 pt-8">
                    <div className="h-px w-full bg-gradient-to-r from-border via-border/50 to-transparent" />
                    <div className="flex justify-center pt-2 text-muted-foreground/60">
