...
export function getWafBlockHtml(props: WafBlockTemplateProps): string {
  ...
  return `
    ...
    <head>
      ...
      <title>Acceso Bloqueado | Agroecotopia Seguridad</title>
      <style>
    ...
    <body>
      <div class="container">
        ...
        <p class="desc">Tu solicitud ha sido interceptada y denegada por el <strong>Firewall de Aplicación (WAF)</strong> de Agroecotopia debido a una política de seguridad estricta.</p>
        <div class="details">
        ...
        <div class="footer">
          Agroecotopia Security Edge &bull; Sistema de Protección Activo
        </div>
      </div>
    </body>
    </html>
